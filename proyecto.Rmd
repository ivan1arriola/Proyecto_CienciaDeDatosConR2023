...
![Diagrama de la base de datos](img/fct_registros.png "Diagrama de la base de datos"){width="300" height="600"}
...
") 
```
Se descubrió que la cantidad de datos que tienen los tres campos en 0 es `r datos_0[1,1]` registros, lo que representa
