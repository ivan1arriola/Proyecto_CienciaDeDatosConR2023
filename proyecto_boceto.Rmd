...
```
```{r Cargar Mapas , sensores, semaforos, message=FALSE  , echo=FALSE}
...
capaSemafotos <- st_read(here::here('app',"v_int_semaforos", "v_int_semaforos.shp"))
...
```{r Importar velocidad - barrio   , echo=FALSE}
(
...
```{r Mapa con velocidad media por barrio , echo=FALSE}
(
...
```{r Importar velocidad - fecha - volumen - avenida  , echo=FALSE}
(
