...
```{r Distribucion de velocidad Barras, fig.cap= "Boxplot de Velocidad"}
velocidad_volumen %>% ggplot() +
...
max_velocidad_hora_barrio <- DBI::dbGetQuery(
    ...
    SELECT
      ...
      AVG(fct_registros.volume) AS avg_volumen,
       CASE
        WHEN fct_registros.id_hora >= 0 AND fct_registros.id_hora < 100 THEN '00:00 - 00:59'
        WHEN fct_registros.id_hora >= 100 AND fct_registros.id_hora < 200 THEN '01:00 - 01:59'
        WHEN fct_registros.id_hora >= 200 AND fct_registros.id_hora < 300 THEN '02:00 - 02:59'
        WHEN fct_registros.id_hora >= 300 AND fct_registros.id_hora < 400 THEN '03:00 - 03:59'
        WHEN fct_registros.id_hora >= 400 AND fct_registros.id_hora < 500 THEN '04:00 - 04:59'
        WHEN fct_registros.id_hora >= 500 AND fct_registros.id_hora < 600 THEN '05:00 - 05:59'
        WHEN fct_registros.id_hora >= 600 AND fct_registros.id_hora < 700 THEN '06:00 - 06:59'
        WHEN fct_registros.id_hora >= 700 AND fct_registros.id_hora < 800 THEN '07:00 - 07:59'
        WHEN fct_registros.id_hora >= 800 AND fct_registros.id_hora < 900 THEN '08:00 - 08:59'
        WHEN fct_registros.id_hora >= 900 AND fct_registros.id_hora < 1000 THEN '09:00 - 09:59'
        WHEN fct_registros.id_hora >= 1000 AND fct_registros.id_hora < 1100 THEN '10:00 - 10:59'
        WHEN fct_registros.id_hora >= 1100 AND fct_registros.id_hora < 1200 THEN '11:00 - 11:59'
        WHEN fct_registros.id_hora >= 1200 AND fct_registros.id_hora < 1300 THEN '12:00 - 12:59'
        WHEN fct_registros.id_hora >= 1300 AND fct_registros.id_hora < 1400 THEN '13:00 - 13:59'
        WHEN fct_registros.id_hora >= 1400 AND fct_registros.id_hora < 1500 THEN '14:00 - 14:59'
        WHEN fct_registros.id_hora >= 1500 AND fct_registros.id_hora < 1600 THEN '15:00 - 15:59'
        WHEN fct_registros.id_hora >= 1600 AND fct_registros.id_hora < 1700 THEN '16:00 - 16:59'
        WHEN fct_registros.id_hora >= 1700 AND fct_registros.id_hora < 1800 THEN '17:00 - 17:59'
        WHEN fct_registros.id_hora >= 1800 AND fct_registros.id_hora < 1900 THEN '18:00 - 18:59'
        WHEN fct_registros.id_hora >= 1900 AND fct_registros.id_hora < 2000 THEN '19:00 - 19:59'
        WHEN fct_registros.id_hora >= 2000 AND fct_registros.id_hora < 2100 THEN '20:00 - 20:59'
        WHEN fct_registros.id_hora >= 2100 AND fct_registros.id_hora < 2200 THEN '21:00 - 21:59'
        WHEN fct_registros.id_hora >= 2200 AND fct_registros.id_hora < 2300 THEN '22:00 - 22:59'
        WHEN fct_registros.id_hora >= 2300 AND fct_registros.id_hora <= 2359 THEN '23:00 - 23:59'
        ELSE 'Unknown'
      END AS hora_rango
    FROM fct_registros
...
```{r Mapa de calor x Barrio x Hora, eval=FALSE, fig.cap="Mapa de calor de volumen maxima por barrio por rango de hora"}
...
Casi todos los barrios donde se dispara el maximo de autos detectados en 5 minutos son los que tienen rambla.
El horario donde se dispara es en la noche.
...
Cuantos vehículos van a pasar en la siguiente hora segun
- es fin de semana
- es día o noche
- velocidad
...
datos_arbol <- DBI::dbGetQuery(
  con,
  "SELECT
    AVG(fct_registros.volumen_hora),
    d_date.weekend_indr AS fin_de_semana,
    d_date.mmyyyy,
    d_sensores.latitud,
    d_sensores.longitud,
     CASE
            WHEN fct_registros.id_hora >= 800 AND fct_registros.id_hora < 2000 THEN 'DIA'
            ELSE 'NOCHE'
    END AS hora_rango,
      CASE
            WHEN fct_registros.velocidad >= 45 THEN 'SI'
            ELSE 'NO'
     END AS exceso_velocidad
    FROM fct_registros
    LEFT JOIN d_date ON fct_registros.id_fecha = d_date.id_fecha
    LEFT JOIN d_sensores ON fct_registros.id_detector = d_sensores.id_detector
    GROUP BY d_date.weekend_indr,hora_rango, d_date.mmyyyy, d_sensores.latitud, d_sensores.longitud, exceso_velocidad
    "
)
...
arbol_vol <- rpart(avg ~ fin_de_semana + hora_rango + exceso_velocidad, data = training)
rpart.plot(arbol_vol, digits = (-5))
