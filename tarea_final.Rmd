...
2.  ¿Cuáles son las calles con los mayores promedios de velocidad en Montevideo?
3.  ¿Cómo va variando el volumen y velocidad medidos a través de la semana?
...
```{r, echo=FALSE, fig.cap = "Es netamente nula la proporcion de excesos de velocidad, podemos decir el los conductores en general respetan los limites de velocidad"}
